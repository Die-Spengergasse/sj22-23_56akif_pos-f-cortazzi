...
namespace LinqUebung1.App
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //    Where liefert IEnumerable, also immer eine Collection.
            ...
            //int result4 = db.Schuelers.Where((s) => s.Klasse.Equals("3BHIF")).Count();
            ...
            int result5 = 0;
            result5 = db.Pruefungen.Where(p => p.Pruefer.Equals("FAV")).Max(p => p.Note);
            ...
            double result6 = 0;
            result6 = db.Pruefungen.Where(s => s.Schueler.Geschlecht.StartsWith("w") && s.Fach.Equals("POS")).Average(p => p.Note);
            ...
            IEnumerable<Schueler> result7 = null;
            result7 = db.Schuelers.Where(p => p.Pruefungen.Count() >= 6);
            ...
            IEnumerable<Schueler> result8 = null;
            result8 = db.Schuelers.Where(s => s.Pruefungen.Any(p => p.Fach == "DBI"));
            ...
            IEnumerable<Schueler> result9 = null;
            result9 = db.Schuelers.Where(p => p.Pruefungen.All(f => f.Fach.Equals("POS")));
            ...
            IEnumerable<Schueler> result11 = null;
            result11 = db.Schuelers.Where(p => p.Pruefungen.Count() == 0);
            ...
            IEnumerable<Pruefung> result12 = null;
            result12 = db.Pruefungen.Where(p => p.Datum.Month == 6 && p.Fach.Equals("AM"));
